...
if(mysqli_num_rows($result)>0){
    ...
    $output .="
            ...
            <div id='carouselExampleIndicators' class='carousel slide' data-ride='carousel'>
                ...
                <div class='carousel-inner' >
                    <div class='carousel-item active' style='width:63rem;'>
                        <img class='d-block w-100' src='http://127.0.0.1/e-cart/img/offerce/2.jpg' alt='First slide'>
                    </div>
                    <div class='carousel-item' style='width:63rem;'>
                        <img class='d-block w-100' src='http://127.0.0.1/e-cart/img/offerce/4.png' alt='Second slide'>
                    </div>
                    <div class='carousel-item' style='width:63rem;'>
                        <img class='d-block w-100' src='http://127.0.0.1/e-cart/img/offerce/3.jpg' alt='Third slide'>
                    </div>
                </div>
        ...
        $output .= "
        <div class='card shadow border-dark ml-1 mt-1' style='width: 16rem;'>
...
<script>
    $(document).ready(function(){
        ...
        var a = $(this).val();
            $.ajax({
                url : "http://127.0.0.1/e-cart/ajax/ajax-cart-pinfo.php",
                type : "POST",
                data : {cpname : a},
