		...
		<div class="container col-lg-4 p-3 mt-4 shadow-lg rounded text-black opct">	
			<form action="#" method="post" >
				...
				<div class="col mt-2">
					...
					<a href="http://127.0.0.1/e-cart/"><button type="button" class="btn btn-warning"><< Back to Login</button></a>
				</div> 
			</form>
		</div>
    </body>
...
<?php
	if(isset($_POST['submit'])){
		...
		$email = $_POST['email'];
		$image = "http://127.0.0.1/e-cart/img/admin.png";
		$add = $_POST['add'];
				...
				if($result){
					if(mysqli_num_rows($result)>0){
						...
						if($result){
                            ...
                            echo "<script>window.location.href = 'http://127.0.0.1/e-cart/';</script>";
						}
					}
				}else{
