...
if(isset($_SESSION['username'])){
        if(isset($_FILES['image'])){
            $no = "http://127.0.0.1/e-cart/img/profile_img/";
            $pass = $_POST['password'];
            $email = $_POST['email'];
            $pno = $_POST['mnumber'];
            ...
            if(!$result){
                ...
                echo "<script> location.href='http://127.0.0.1/e-cart/home/'</script>";
            }
        }
    }
?>
<script>
    $(document).ready(function(){
        $("#products").click(function(){
            location.href='http://127.0.0.1/e-cart/';
        });
        $("#add-cart").click(function(){
            location.href= 'http://127.0.0.1/e-cart/home/order.php';
        });
        $("#buy").click(function(){
            location.href= 'http://127.0.0.1/e-cart/home/product.php';
        });
...
<script>
    $(document).ready(function(){
      $.ajax({
            url : "http://127.0.0.1/e-cart/ajax/ajax-add-homepage-counter.php",
            type: "POST",
