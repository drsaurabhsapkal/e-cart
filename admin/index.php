            ...
            <div class="row row-col-2 ml-2">
                <div class="col-3">
                    <div class="col-md-6 ml-5 mt-5 text-center">
                        <img src="http://127.0.0.1/e-cart/img/admin.png" class="rounded img-fluid img-thumbnail" width="80%">
                    </div>
                    <dl class="row">
...
<script src="http://127.0.0.1/e-cart/javascript/sweet.js"></script>
<script>
    $(document).ready(function(){
        $("#products").click(function(){
            location.href='http://127.0.0.1/e-cart/admin/products.php';
        });
        $("#buy").click(function(){
            location.href='http://127.0.0.1/e-cart/admin/buy.php';
        });
        $("#to-pay").click(function(){
            alert('Go to cart and Pay Bils..!');
        });
        $("#add-cart").click(function(){
            location.href='http://127.0.0.1/e-cart/admin/cart.php';
        });
        $("#payed").click(function(){
            location.href='http://127.0.0.1/e-cart/admin/users.php';
        });
    });
</script>
<script>
    $(document).ready(function(){
      $.ajax({
            url : "http://127.0.0.1/e-cart/ajax/ajax-admin-counter.php",
            type: "POST",
